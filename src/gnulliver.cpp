...
unsigned gnulliver32(unsigned input) {
    ...
    if (endian != GNULLIVER_BIG) {
        if (endian == GNULLIVER_LITTLE) {
            tmpch = bytes.ch[0];
            bytes.ch[0] = bytes.ch[3];
            bytes.ch[3] = tmpch;
            tmpch = bytes.ch[1];
            bytes.ch[1] = bytes.ch[2];
            bytes.ch[2] = tmpch;
        }
        else { /* endian == GNULLIVER_DEC */
            tmpch = bytes.ch[0];
            bytes.ch[0] = bytes.ch[2];
            bytes.ch[2] = tmpch;
            tmpch = bytes.ch[1];
            bytes.ch[1] = bytes.ch[3];
            bytes.ch[3] = tmpch;
        }
    }
...
unsigned long gnulliver64(unsigned long input) {
    ...
    if (endian != GNULLIVER_BIG) {
        if (endian == GNULLIVER_LITTLE) {
            tmpch = bytes.ch[0];
            bytes.ch[0] = bytes.ch[7];
            bytes.ch[7] = tmpch;
            tmpch = bytes.ch[1];
            bytes.ch[1] = bytes.ch[6];
            bytes.ch[6] = tmpch;
            tmpch = bytes.ch[2];
            bytes.ch[2] = bytes.ch[5];
            bytes.ch[5] = tmpch;
            tmpch = bytes.ch[3];
            bytes.ch[3] = bytes.ch[4];
            bytes.ch[4] = tmpch;
        }
        else { /* Assume GNULLIVER_DEC */
            tmpch = bytes.ch[0];
            bytes.ch[0] = bytes.ch[6];
            bytes.ch[6] = tmpch;
            tmpch = bytes.ch[1];
            bytes.ch[1] = bytes.ch[7];
            bytes.ch[7] = tmpch;
            tmpch = bytes.ch[2];
            bytes.ch[2] = bytes.ch[4];
            bytes.ch[4] = tmpch;
            tmpch = bytes.ch[3];
            bytes.ch[3] = bytes.ch[5];
            bytes.ch[5] = tmpch;
        }
    }
...
unsigned long long gnulliver128(unsigned long long input) {
    ...
    if (endian != GNULLIVER_BIG) {
        if (endian == GNULLIVER_LITTLE) {
            tmpch = bytes.ch[0];
            bytes.ch[0] = bytes.ch[15];
            bytes.ch[15] = tmpch;
            tmpch = bytes.ch[1];
            bytes.ch[1] = bytes.ch[14];
            bytes.ch[14] = tmpch;
            tmpch = bytes.ch[2];
            bytes.ch[2] = bytes.ch[13];
            bytes.ch[13] = tmpch;
            tmpch = bytes.ch[3];
            bytes.ch[3] = bytes.ch[12];
            bytes.ch[12] = tmpch;
            tmpch = bytes.ch[4];
            bytes.ch[4] = bytes.ch[11];
            bytes.ch[11] = tmpch;
            tmpch = bytes.ch[5];
            bytes.ch[5] = bytes.ch[10];
            bytes.ch[10] = tmpch;
            tmpch = bytes.ch[6];
            bytes.ch[6] = bytes.ch[ 9];
            bytes.ch[ 9] = tmpch;
            tmpch = bytes.ch[7];
            bytes.ch[7] = bytes.ch[ 8];
            bytes.ch[ 8] = tmpch;
        }
        else { /* Assume GNULLIVER_DEC */
            tmpch = bytes.ch[0];
            bytes.ch[0] = bytes.ch[14];
            bytes.ch[14] = tmpch;
            tmpch = bytes.ch[1];
            bytes.ch[1] = bytes.ch[15];
            bytes.ch[15] = tmpch;
            tmpch = bytes.ch[2];
            bytes.ch[2] = bytes.ch[12];
            bytes.ch[12] = tmpch;
            tmpch = bytes.ch[3];
            bytes.ch[3] = bytes.ch[13];
            bytes.ch[13] = tmpch;
            tmpch = bytes.ch[4];
            bytes.ch[4] = bytes.ch[10];
            bytes.ch[10] = tmpch;
            tmpch = bytes.ch[5];
            bytes.ch[5] = bytes.ch[11];
            bytes.ch[11] = tmpch;
            tmpch = bytes.ch[6];
            bytes.ch[6] = bytes.ch[ 8];
            bytes.ch[ 8] = tmpch;
            tmpch = bytes.ch[7];
            bytes.ch[7] = bytes.ch[ 9];
            bytes.ch[ 9] = tmpch;
        }
    }
